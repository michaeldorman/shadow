...
```{r, include=FALSE}
file.copy("README-abstract.png", "docs/README-abstract.png")
file.copy("README-demo1-1.png", "docs/README-demo1-1.png")
file.copy("README-demo1-2.png", "docs/README-demo1-2.png")
```
